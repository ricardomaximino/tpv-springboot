...
/**
 * Esta clase extende javax.swing.JMenu y implementa la interfaz 
 * com.brasajava.util.interfaces.GruopAndCommandActionName;
 * @author Ricardo Maximino
 */
public class MiMenu extends JMenu implements GroupAndCommandActionName{
     ...
     */
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public MiMenu(String name,String group,String commandActionName){
        super();
        this.setName(name);
        this.group = group;
